...
import { Root,
  Container, Content,Header, List, ListItem, Thumbnail, Tab, Tabs, Grid,
...
export default class TimelineScreen extends React.Component {
  ...
  filterPostArray() { 
    ...
    var temp = post_array.filter(function(item){
      if(item.tags === title){
        return true;
      }
      return false;
      ...
      return (
        ...
        {/* <Head/> */}
          <Content>
            ...
            >
              <Grid style={{padding:20}}>
                <Row size={2}>
                    ...
                    <Body style={{}}>
                        ...
                        <Avatar rounded  size={'large'} 
                          ...
                          />
                          <Badge value={26} badgeStyle={{backgroundColor:'#00b7af'}}
                            containerStyle={{ position: 'absolute', right: -10, left:40 }}></Badge>
                        </View>
                    </Body>
                ...
                <Row size={1.5}>
                  <Body>
                    <Text style={{color:'white', fontSize:24, fontWeight:'bold'}}>{this.props.storyTitle}</Text>
                  </Body>
                </Row>
                ...
                <Row size={1} style={{justifyContent:'center'}}>
                  <Text style={{ color:'#fff', textAlign:'center'}}>Our travel pics from our Mexico trip 2019  </Text>
                </Row>
                <Row size={1} style={{justifyContent:'center'}}>
                  <Button 
                    style={{ borderWidth:0 , borderRadius:20, margin:10,width:80,height:30,
                    backgroundColor:'white', alignSelf:'center', justifyContent:'center'}}
                  >
                    <Text uppercase={false} numberOfLines={1} style={{color:'#000', fontSize:wp('2.5%')}}>#cabo</Text>
                  </Button>
                  <Button 
                    style={{ borderWidth:0 , borderRadius:20, margin:10,width:80,height:30,
                    backgroundColor:'white', alignSelf:'center', justifyContent:'center'}}
                  >
                    <Text uppercase={false} numberOfLines={1} style={{color:'#000', fontSize:wp('2.5%')}}>#ixtapa</Text>
                  </Button>
                ...
                renderItem={({item,index}) => 
                  <Swipeout 
                    ...
                    <View style={{margin:16}}>
                      <Post type='timeline' pdata={item}></Post>
                    </View>
                  </Swipeout>
                }
          ...
          <View style={styles.bottombar}>
              <Left>
                  <Button rounded style={styles.recordbtn}
                      onPress={() => Actions.Record()}>
                    <Icon type={"Foundation"} name="record" style={{color:'#00b7af'}}/>
                  </Button>
              </Left>
              <Body>
                <Button style={styles.publishbtn}
                  ...
                  <ActionSheet
                    ...
                    title={<Text style={{color: '#00b7af', fontSize: 18}}>Publish Story</Text>}
                    options={[
                              '', 
                              <Text style={{color: 'black'}}>Create a link</Text>,
                              <Text style={{color: 'black'}}>Publish to facebook</Text>,
                              <Text style={{color: 'black'}}>Export Images to Album</Text>, 
