...
import { SIGNUP_MUTATION, SIGNUPWITHFB_MUTATION } from "./graphql/gql";
...
export default class SignupScreen extends React.Component {
  ...
  onSignupPress(createUser) {
    ...
    if (
      this.state.email_validated &&
      this.state.password_validated &&
      this.state.fullname_validated &&
  ...
  async onSignupWithFacebook(signUpWithFacebook) {
    ...
    if (result.isCancelled) {
      ...
      data = await AccessToken.getCurrentAccessToken();
      {
        ...
        this.setState({ signup_processing: true });
        signUpWithFacebook({
          variables: { token: data.accessToken.toString() }
        });
      }
    }
  }
          ...
          <KeyboardAvoidingView style={styles.containerView} behavior="static">
            <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
              <Grid>
                ...
                >
                  <Mutation
                    mutation={SIGNUPWITHFB_MUTATION}
                  ...
                  >
                    {signUpWithFacebook => (
                      <TouchableOpacity
                        ...
                        onPress={() =>
                          this.onSignupWithFacebook(signUpWithFacebook)
                        }
                      >
                        <View
                          style={{
                ...
                <Row size={6} style={{ justifyContent: "center" }}>
                  <Form style={{ width: "90%" }}>
                    ...
                    <Item>
                      ...
                      />
                      {this.state.fullname != "" &&
                        this.state.fullname_validated == true && (
                          <Icon
                      ...
                      {this.state.fullname != "" &&
                        this.state.fullname_validated == false && (
                    ...
                    <Item>
                      ...
                      />
                      {this.state.password != "" &&
                        this.state.password_validated == true && (
                          <Icon
                            name="checkmark-circle"
                            style={{ color: "#0FF22D" }}
                          />
                      ...
                      {this.state.password != "" &&
                        this.state.password_validated == false && (
                          <Icon name="close-circle" style={{ color: "#eee" }} />
                        )}
                    </Item>
                    ...
                    <Item>
                      <TextInput
                        ...
                        onChangeText={text =>
                          this.validatePassword_confirm(text)
                        }
                        ref={ref => {
                          this.input4 = ref;
                        }}
