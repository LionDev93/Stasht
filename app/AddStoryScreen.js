        ...
        <ImageBackground
          ...
          source={
            this.state.imageSource
              ...
              : require("./images/timeline_bg.png")
          }
        ...
        <Content>
          ...
          >
            <SearchableDropDown
              ...
              onTextChange={text => {
                this.setState({ stashtag: text });
              }}
              onItemSelect={item => {
                this.ontagItemSelect;
              }}
              itemStyle={{
                padding: 10,
                marginTop: 2,
            ...
            >
              <Image
                style={{}}
                source={require("./images/info-with-circle.png")}
              />
            </TouchableOpacity>
          </Row>
          ...
          <Row style={{ margin: 12, height: "auto" }}>
            <Row style={{ width: "100%" }}>
              <Button
                rounded
                style={{ width: 45, height: 45, backgroundColor: "#00b7af" }}
          ...
          <Row style={{ backgroundColor: "#ddd", height: 50 }}>
            <Text style={{ left: 30, alignSelf: "center", fontWeight: "bold" }}>
              Add from Library
            </Text>
          </Row>
            ...
            <CameraRollPicker
              ...
              selectedMarker={
                <Image
                  ...
                  source={require("./images/selected-overlay.png")}
                  resizeMode="stretch"
                />
              }
