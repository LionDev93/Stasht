...
import {Container, Content, Grid, Button, Icon, Card, CardItem, Left,Form, Header,
    Thumbnail, Body, Right,  View, Text, ListItem, Row, Col, Textarea} from 'native-base';
    ...
    render() {
      return (
        <Container>
            <Header   style={{ backgroundColor:'white'}}>
                <Grid>
                    ...
                    <Col size={3} style={{ justifyContent:'center', alignItems:'center'}}>
                        <Text style={{fontWeight:'bold', fontSize:24, color:'#00b7af'}}>Edit Post</Text>
                    </Col>
            ...
            <Content>
                <KeyboardAvoidingView  style={{width:'100%', height:'100%'}}  enabled={true}
                            ...
                            <View style={ styles.PostContent}>
                                <Form>
                                    <Textarea 
                                        ...
                                        rowSpan={8} bordered multiline
                                        value={this.state.textcontent}
                                        onChangeText={text => {
                                            this.setState({textcontent: text});
                                            this.inputRef.setNativeProps({ selection:{ start:this.state.cursorPosition, end: this.state.cursorPosition} });
                                            }
                                        }
                                        onSelectionChange={(event) => this.onCursor(event)}
                                    />
                                </Form>
                                <TouchableOpacity onPress={this.onEmoji} style={{margin:10}} >
                                    <Image source={require('./images/emoji.png')} //this.props.pdata.post_type
